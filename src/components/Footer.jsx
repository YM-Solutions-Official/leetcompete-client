  ...
  return (
    <footer className="bg-zinc-950 border-t border-zinc-800 py-12 px-4 relative overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
        <h2
          className="text-[8rem] md:text-[12rem] font-black bg-gradient-to-b from-white/5 to-zinc-800/5 bg-clip-text text-white
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-8 justify-items-center md:justify-items-start">
          ...
          <div>
            ...
            <p className="text-zinc-400 mb-4 max-w-md">
              The ultimate platform for competitive programming. Challenge
              yourself, compete with others, and level up your coding skills.
            </p>
        ...
        <div className="border-t border-zinc-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-500 text-sm">
            © 2025 LeetCompete. All rights reserved.
          </p>
