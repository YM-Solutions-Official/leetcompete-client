...
function FeaturesSection() {
    ...
    const getColorClasses = (color) => {
        const colors = {
            ...
            green: "border-green-500/30 hover:border-green-500 group-hover:text-green-400",
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className={`group bg-zinc-900 p-8 rounded-xl border-2 ${getColorClasses(feature.color)} transition-all hover:scale-105 hover:shadow-2xl`}
                            >
