    ...
    const [matchHistory] = useState([
        {
            ...
            problems: [
                ...
                { name: "Median of Two Sorted Arrays", solved: false, difficulty: "Hard" },
        ...
        },
        {
            ...
            problems: [
                ...
                { name: "Container With Most Water", solved: false, difficulty: "Medium" },
                ...
                <div className="max-w-4xl mx-auto pt-10">
                    ...
                    {matchHistory.length === 0 ? (
                        <div className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700 rounded-xl p-12 text-center">
                            ...
                            <p className="text-zinc-500 text-sm mt-2">Start battling to see your match history!</p>
                        </div>
                    ) : (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className="text-zinc-400 font-medium">Match Id:</span>
                                            <span className="text-white font-mono">{match.matchId}</span>
                                        </div>

                                        {/* Opponent */}
                                        <div className="flex items-center gap-2">
                                            <span className="text-zinc-400 font-medium">Against:</span>
                                            <span className="text-white">{match.opponent}</span>
                                        </div>

                                        {/* Problems Solved */}
                                        <div className="flex items-center gap-2">
                                            <span className="text-zinc-400 font-medium">Problem Solve:</span>
                                            <span className="text-white">{match.problemsSolved}</span>
                                        </div>
                ...
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-zinc-900 border border-zinc-700 rounded-2xl max-w-3xl w-full relative shadow-2xl max-h-[90vh] flex flex-col">
                        ...
                        <div className="p-6 border-b border-zinc-700">
                            <h2 className="text-2xl font-bold text-white pr-8 text-center">Match Details</h2>
                        </div>
                        ...
                        <div className="overflow-y-auto p-6 flex-1">
                            ...
                            <div className="space-y-4 mb-6">
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <p className="text-white font-mono text-sm">{selectedMatch.matchId}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white text-sm">{formatDuration(selectedMatch.duration)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <p className="text-white text-sm">{selectedMatch.opponent}</p>
                                    </div>
                                    <div>
                                        <p className="text-zinc-400 text-xs mb-1">Points</p>
                                        <p className="text-white text-sm font-semibold">{selectedMatch.points}</p>
                                    </div>
                                    <div>
                                        <p className="text-zinc-400 text-xs mb-1">Result</p>
                                        <p className={`text-sm font-semibold flex items-center gap-1 ${
                                            selectedMatch.result === "Win" ? "text-green-500" : "text-red-500"
                                        }`}>
                            ...
                            <div className="mt-6 pt-6 border-t border-zinc-700">
                                <h3 className="text-xl font-semibold text-white mb-4">Problem Breakdown</h3>
                                <div className="space-y-3">
                                    {selectedMatch.problems && selectedMatch.problems.map((problem, idx) => (
                                        <div 
                                            key={idx}
