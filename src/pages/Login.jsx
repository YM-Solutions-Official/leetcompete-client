  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 flex items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-4xl mx-auto bg-white/95 backdrop-blur-sm shadow-2xl rounded-xl lg:rounded-2xl flex flex-col lg:flex-row overflow-hidden relative z-10">
        ...
        <button
        onClick={() => navigate("/")}
        className="absolute top-1 right-4 sm:top-6 sm:right-6 px-3 py-2 sm:px-4 bg-zinc-800/80 hover:bg-zinc-700 text-white rounded-lg font-medium transition-all border border-zinc-600 flex items-center gap-2 backdrop-blur-sm text-sm sm:text-base z-20"
      >
        <span className="hidden sm:inline">Return to Home</span><span className="sm:hidden">Home</span> <span>→</span>
          ...
          <div className="text-center lg:text-left mb-6">
            ...
            <p className="text-zinc-600 text-sm sm:text-base">Sign in to your account and continue coding</p>
          </div>
            ...
            <div className="flex items-center justify-between text-xs">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-3 w-3 text-blue-600 focus:ring-blue-500 border-zinc-300 rounded"
                />
                <label htmlFor="remember-me" className="ml-2 text-zinc-700">
                  Remember me
                </label>
              </div>
              <button
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-zinc-900 via-zinc-800 to-black relative overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center p-8 text-center relative z-10">
            <div className="mb-6">
              ...
              />
              <h2 className="text-2xl font-bold text-white mb-3">Welcome Back to LeetCompete</h2>
              <p className="text-zinc-300 text-base leading-relaxed max-w-sm">
                Continue your coding journey and compete with developers worldwide
              </p>
            </div>
